...
export default function Brief(props) {
    ...
    // console.log(style)
    return (
        <div className="_1vEhpLOL_0" style={style}>
            ...
            <div className="_2NKpEZ4f_0"><div className="_2VrPoUeX_0">
                <h2>你将获得</h2> </div>
                <div className="_3uBK1dPI_0 _18IFJWYN_0">
                    <div className="_3CegnU7h_0"><
                        ul>
    ...
    <span className="iconfont _3NDdjNCy_0"></span></div></div></div>
            ...
            <div className="_2NKpEZ4f_0"><div className="_2VrPoUeX_0"><h2>课程目录</h2> </div>
                <div className="_3uBK1dPI_0"><div className="_3CegnU7h_0">
                    <p><img src="https://static001.geekbang.org/resource/image/1b/ae/1b969cfe410a43d5f2b148c255beb3ae.jpg" alt="" /></p>
                </div> <div className="_2p3Arjga_0"><div className="_3c8AULUO_0">查看更多<span className="iconfont _3NDdjNCy_0"></span></div></div></div> <div className="_3ooJE-Ce_0"></div></div><div className="_2NKpEZ4f_0"><div className="_2VrPoUeX_0"><h2>特别放送</h2> </div> <div className="_3uBK1dPI_0 _18IFJWYN_0"><div className="_3CegnU7h_0"><ol className="js-audit">
...
<a href="https://shop18793264.youzan.com/v2/feature/XRArFM4uO5?dc_ps=2534794065267047432.200001">戳此查看&gt;&gt;&gt;</a>
                    ...
                    <p><a href="time://mall?url=https%3A%2F%2Fshop18793264.youzan.com%2Fv2%2Ffeature%2FXRArFM4uO5"><img src="https://static001.geekbang.org/resource/image/48/e5/4863766d629aeaffe4d1f685fef117e5.png" alt="unpreview" /></a></p>
                </ol></div>
                </div>
